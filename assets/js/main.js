...
$(document).ready(function() {
    $("#contactForm").on("submit", function(event) {
        ...
        $.ajax({
            url: "send_email.php", // La URL del script PHP
            type: "POST",
            data: $(this).serialize(), // Envía todos los datos del formulario
            success: function(response) {
                $("#formMessage").html("<p>El mensaje ha sido enviado exitosamente.</p>");
            },
            error: function(xhr, status, error) {
                $("#formMessage").html("<p>Hubo un error al enviar el mensaje. Por favor, inténtalo de nuevo.</p>");
            }
        });
    });
});
